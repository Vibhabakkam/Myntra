function register(event) {
    ...
    var MyntrauserData = { name: userName, number : userPhone, email: userEmail, password: userPassword }

    // storing data from js to ls
    var dataFromLS = JSON.parse(localStorage.getItem("MyntrauserData")) || [];
    ...
    if (flag === true) {
        ...
        dataFromLS.push(MyntrauserData);
        localStorage.setItem("MyntrauserData", JSON.stringify(dataFromLS));
...
function login(event){
    ...
    var MyntrauserData = { email: userEmail, password: userPassword }
...
function addToLS() {
    ...
    var MyntrauserProduct = {  proImg:Imge, proName: Name, proPrice:Price }
    // store deta from java script to local storage
    var dataFromLS = JSON.parse(localStorage.getItem("MyntrauserProduct")) || [];
    console.log(dataFromLS, 'dataFromLS')
  
    dataFromLS.push(MyntrauserProduct);
    localStorage.setItem("MyntrauserProduct", JSON.stringify(dataFromLS));
    alert("product added")
