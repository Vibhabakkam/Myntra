window.onload = function () {
    ...
    var products = JSON.parse(localStorage.getItem("MyntrauserProduct"));
  ...
  function addToCart(pro){
      alert("worked");
      var MyntrauserProduct =JSON.stringify(pro);
      ...
      if(currentUser){
          ...
          for( var i=0; i<dataFromLs.length; i++){
              if(dataFromLs[i].email === currentUser["current-user-email"]){
                  ...
                  newObj["cartProducts"].push(JSON.parse(MyntrauserProduct));
